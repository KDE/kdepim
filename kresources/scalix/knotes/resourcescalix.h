/*
    ...
    Scalix storage format. See www.kolab.org for documentation on this.
 ...
 * clients).
 */
class KNOTESSCALIX_EXPORT ResourceScalix : public ResourceNotes,
