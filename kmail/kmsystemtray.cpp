...
{
  for ( QMap<QGuardedPtr<KMFolder>, bool>::Iterator it_pendingUpdates = mPendingUpdates.begin();
        it_pendingUpdates != mPendingUpdates.end(); ++it_pendingUpdates)
  {
  KMFolder *fldr = it_pendingUpdates.key();
