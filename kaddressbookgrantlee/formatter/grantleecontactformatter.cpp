...
QString GrantleeContactFormatter::toHtml( HtmlForm form ) const
{
    ...
    if ( birthday.isValid() ) {
        insertVariableToQVariantHash(contactObject, QLatin1String( "birthdayi18n" ));
    ...
    if ( anniversary.isValid() ) {
        ...
        insertVariableToQVariantHash(contactObject, QLatin1String("anniversaryi18n") );
    }
    ...
    insertVariableToQVariantHash(contactObject, QLatin1String( "emailsi18n" ) );
   ...
   const QStringList customs = rawContact.customs();
    ...
    if ( rawContact.url().isValid() ) {
        ...
        insertVariableToQVariantHash(contactObject, QLatin1String( "websitei18n" ) );
    }
    ...
    if ( !blog.isEmpty() ) {
        ...
        insertVariableToQVariantHash(contactObject, QLatin1String( "blogUrli18n" ) );
    }
    ...
    if ( !addressBookName.isEmpty() ) {
        ...
        insertVariableToQVariantHash(contactObject, QLatin1String( "addressBookNamei18n" ) );
    }
    ...
    if ( !rawContact.note().isEmpty() ) {
        ...
        insertVariableToQVariantHash(contactObject, QLatin1String( "notei18n" ) );
    }
    ...
    insertVariableToQVariantHash(contactObject, QLatin1String( "departmenti18n" ) );
    ...
    insertVariableToQVariantHash(contactObject, QLatin1String( "Professioni18n" ) );
    setHashField( contactObject, QLatin1String( "office" ),
                  rawContact.custom( QLatin1String( "KADDRESSBOOK" ),
                                     QLatin1String( "X-Office" ) ) );
    insertVariableToQVariantHash(contactObject, QLatin1String( "officei18n" ) );

    setHashField( contactObject, QLatin1String( "manager" ),
                  rawContact.custom( QLatin1String( "KADDRESSBOOK" ),
                                     QLatin1String( "X-ManagersName" ) ) );
    insertVariableToQVariantHash(contactObject, QLatin1String( "manageri18n" ) );

    setHashField( contactObject, QLatin1String( "assistant" ),
                  rawContact.custom( QLatin1String( "KADDRESSBOOK" ),
                                     QLatin1String( "X-AssistantsName" ) ) );
    insertVariableToQVariantHash(contactObject, QLatin1String( "assistanti18n" ) );

    setHashField( contactObject, QLatin1String( "spouse" ),
                  rawContact.custom( QLatin1String( "KADDRESSBOOK" ),
                                     QLatin1String( "X-SpousesName" ) ) );
    insertVariableToQVariantHash(contactObject, QLatin1String( "spousei18n" ) );

    setHashField( contactObject, QLatin1String( "imAddress" ),
                  rawContact.custom( QLatin1String( "KADDRESSBOOK" ),
                                     QLatin1String( "X-IMAddress" ) ) );
    insertVariableToQVariantHash(contactObject, QLatin1String( "imAddressi18n" ));
