...
LIBKMOBILETOOLSENGINEUI_RCS="`find libkmobiletoolsengineui -name \"*.ui\" -o -name \"*.rc\" -o -name \"*.kcfg\"`"
...
LIBKMOBILETOOLSENGINEUI_SRCS="`find libkmobiletoolsengineui -name \"*.cpp\" -o -name \"*.h\"`"
