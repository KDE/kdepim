...
{
  //FIXME(Andras) port to akonadi saveLayout( KMKernel::config(), configGroup, configEntry );
}
...
{
//FIXME(Andras) port to akonadi   startHandleAttachmentCommand( KMHandleAttachmentCommand::Open );
}

void KMMimePartTree::slotOpenWith()
{
  //FIXME(Andras) port to akonadi startHandleAttachmentCommand( KMHandleAttachmentCommand::OpenWith );
}

void KMMimePartTree::slotView()
{
  //FIXME(Andras) port to akonadi startHandleAttachmentCommand( KMHandleAttachmentCommand::View );
}

void KMMimePartTree::slotProperties()
{
  //FIXME(Andras) port to akonadi startHandleAttachmentCommand( KMHandleAttachmentCommand::Properties );
}
