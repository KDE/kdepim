...
#ifndef AKREGATOR2_PLUGIN_H
#define AKREGATOR2_PLUGIN_H
...
#define AKREGATOR2_PLUGIN_INTERFACE_VERSION 4

namespace Akregator2 {

class AKREGATOR2INTERFACES_EXPORT Plugin : public QObject
{
    Q_OBJECT
    public:
