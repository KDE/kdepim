...
#include "akregator2_config_browser.h"
...
K_PLUGIN_FACTORY(KCMAkregator2BrowserConfigFactory, registerPlugin<KCMAkregator2BrowserConfig>();)
K_EXPORT_PLUGIN(KCMAkregator2BrowserConfigFactory( "kcmakrbrowserconfig" ))

KCMAkregator2BrowserConfig::KCMAkregator2BrowserConfig( QWidget* parent, const QVariantList& args )
    : KCModule( KCMAkregator2BrowserConfigFactory::componentData(), parent, args ), m_widget( new QWidget )
{  
...
#include "akregator2_config_browser.moc"
