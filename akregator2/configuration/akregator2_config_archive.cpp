...
#include "akregator2_config_archive.h"
...
K_PLUGIN_FACTORY(KCMAkregator2ArchiveConfigFactory, registerPlugin<KCMAkregator2ArchiveConfig>();)
K_EXPORT_PLUGIN(KCMAkregator2ArchiveConfigFactory( "kcmakrarchiveconfig" ))

KCMAkregator2ArchiveConfig::KCMAkregator2ArchiveConfig( QWidget* parent, const QVariantList& args )
    : KCModule( KCMAkregator2ArchiveConfigFactory::componentData(), parent, args ), m_widget( new QWidget )
{
...
void KCMAkregator2ArchiveConfig::load()
{
    setArchiveMode( Settings::archiveMode() );
    KCModule::load();
}

void KCMAkregator2ArchiveConfig::save()
{
...
void KCMAkregator2ArchiveConfig::setArchiveMode( int mode )
{
...
int KCMAkregator2ArchiveConfig::archiveMode() const {
...
#include "akregator2_config_archive.moc"
