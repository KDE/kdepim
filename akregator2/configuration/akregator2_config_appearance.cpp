...
#include "akregator2_config_appearance.h"
...
K_PLUGIN_FACTORY(KCMAkregator2AppearanceConfigFactory, registerPlugin<KCMAkregator2AppearanceConfig>();)
K_EXPORT_PLUGIN(KCMAkregator2AppearanceConfigFactory( "kcmakrappearanceconfig" ))

KCMAkregator2AppearanceConfig::KCMAkregator2AppearanceConfig( QWidget* parent, const QVariantList& args )
    : KCModule( KCMAkregator2AppearanceConfigFactory::componentData(), parent, args ), m_widget( new QWidget )
{  
...
#include "akregator2_config_appearance.moc"
