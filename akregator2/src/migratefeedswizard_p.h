...
#ifndef AKREGATOR2_MIGRATEFEEDSWIZARD_P_H
#define AKREGATOR2_MIGRATEFEEDSWIZARD_P_H
...
public:
    ...
    void connectJob( Akregator2::ImportItemsJob* job, const QString& title );
    ...
    void itemImportFinished( const Akregator2::ImportItemsJob* job, const QString& title );
...
#endif // AKREGATOR2_MIGRATEFEEDSWIZARD_P_H
