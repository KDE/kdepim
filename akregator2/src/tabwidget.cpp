...
void TabWidget::slotAddFrame(Frame* frame)
{
    ...
    connect(frame, SIGNAL(signalTitleChanged(Akregator2::Frame*,QString)),
            this, SLOT(slotSetTitle(Akregator2::Frame*,QString)));
    connect(frame, SIGNAL(signalIconChanged(Akregator2::Frame*,QIcon)),
            this, SLOT(slotSetIcon(Akregator2::Frame*,QIcon)));
...
void TabWidget::slotSetIcon(Akregator2::Frame* frame, const QIcon& icon)
{
