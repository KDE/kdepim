...
#ifndef AKREGATOR2_OPENURLREQUEST_H
#define AKREGATOR2_OPENURLREQUEST_H
...
class OpenUrlRequest
{
    public:
        ...
        /**
         * Akregator2-specific options specifying how a link should be handled.
...
#endif // AKREGATOR2_OPENURLREQUEST_H
