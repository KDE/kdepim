...
#ifndef AKREGATOR2_FEEDICONMANAGER_H
#define AKREGATOR2_FEEDICONMANAGER_H
...
class AKREGATOR2PART_EXPORT FaviconListener
{
public:
...
class AKREGATOR2PART_EXPORT FeedIconManager : public QObject
{
    Q_OBJECT
    Q_CLASSINFO("D-Bus Interface", "org.kde.akregator2.feediconmanager")
    ...
    private:
        ...
        class Private;
        friend class ::Akregator2::FeedIconManager::Private;
        Private* const d;
...
#endif // AKREGATOR2_FEEDICONMANAGER_H
