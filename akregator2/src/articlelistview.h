...
*/
#ifndef AKREGATOR2_ARTICLELISTVIEW_H
#define AKREGATOR2_ARTICLELISTVIEW_H
...
class AKREGATOR2PART_EXPORT SortColorizeProxyModel : public QSortFilterProxyModel {
    Q_OBJECT
public:
...
private:
    ...
    std::vector<boost::shared_ptr<const Akregator2::Filters::AbstractMatcher> > m_matchers;
};


class AKREGATOR2PART_EXPORT ArticleListView : public Akonadi::EntityTreeView, public ArticleLister
{
    Q_OBJECT
...
#endif // AKREGATOR2_ARTICLELISTVIEW_H
