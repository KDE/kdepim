...
#ifndef AKREGATOR2_TABWIDGET_H
#define AKREGATOR2_TABWIDGET_H
...
class TabWidget : public KTabWidget
{
    ...
    public slots:
        ...
        void slotSetIcon(Akregator2::Frame* frame, const QIcon& icon);
        void slotSettingsChanged();
        void slotNextTab();
        void slotPreviousTab();
        void slotRemoveCurrentFrame();
        void slotAddFrame(Akregator2::Frame* f);
