...
#ifndef AKREGATOR2_PLUGINMANAGER_H
#define AKREGATOR2_PLUGINMANAGER_H
...
class Plugin;
class AKREGATOR2PART_EXPORT PluginManager
{
    public:
         ...
         * @see               http://developer.kde.org/documentation/library/kdeqt/tradersyntax.html
         */
        static Akregator2::Plugin* createFromQuery( const QString& constraint = QString() );
         ...
         * @return            Pointer to Plugin, or NULL if error
         */
        static Akregator2::Plugin* createFromService( const KService::Ptr service, QObject *parent = 0 );

        /**
         * Remove library and delete plugin
         * @param plugin      Pointer to plugin
         */
        static void unload( Akregator2::Plugin* plugin );
         ...
         */
        static KService::Ptr getService( const Akregator2::Plugin* plugin );
    ...
    private:
        struct StoreItem {
            Akregator2::Plugin* plugin;
            KService::Ptr service;
        };

        static std::vector<StoreItem>::iterator lookupPlugin( const Akregator2::Plugin* plugin );
...
#endif // AKREGATOR2_PLUGINMANAGER_H
