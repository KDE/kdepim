...
#ifndef AKREGATOR2_BROWSERFRAME_H
#define AKREGATOR2_BROWSERFRAME_H
...
class AKREGATOR2_EXPORT BrowserFrame : public Frame, public virtual FaviconListener
{
    Q_OBJECT
...
#endif // AKREGATOR2_BROWSERFRAME_H
