...
#ifndef AKREGATOR2_SEARCHBAR_H
#define AKREGATOR2_SEARCHBAR_H
...
class SearchBar : public KHBox
{
    ...
    signals:
        ...
        void signalSearch( const std::vector<boost::shared_ptr<const Akregator2::Filters::AbstractMatcher> > & );
