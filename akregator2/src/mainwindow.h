...
#ifndef AKREGATOR2_MAINWINDOW_H
#define AKREGATOR2_MAINWINDOW_H
...
public:
    BrowserInterface(Akregator2::MainWindow *shell, const char *name );

private:
    Akregator2::MainWindow *m_shell;
};
...
protected:
    ...
    /**
     * This is called when exiting akregator2 in order to be able to restore
     * its state next time it starts.
     */
    void autoSaveProperties();

    /**
     * This function is called when starting akregator2 and it will restore
     * the state akregator2 the last time it was closed if possible.
     */
...
private:
    ...
    QPointer<Akregator2::Part> m_part;
