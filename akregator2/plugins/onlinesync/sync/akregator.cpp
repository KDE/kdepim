...
Akregator2::Akregator2( QObject* p ) : Aggregator( p ) 
{
    kDebug();
}

Akregator2::~Akregator2() 
{
    kDebug();
}

SubscriptionList Akregator2::getSubscriptionList() const 
{
    kDebug();
    return _subscriptionList;
}

void Akregator2::load() 
{
    kDebug();
...
void Akregator2::sendSignalLoadDone() 
{
    emit loadDone();
}

void Akregator2::add( const SubscriptionList & list) 
{
    kDebug();
...
void Akregator2::update(const SubscriptionList & list) 
{
    Q_UNUSED(list)
    kDebug();
...
void Akregator2::remove(const SubscriptionList & list) 
{
    kDebug();
