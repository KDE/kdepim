...
void KDescendantsProxyModelPrivate::updateInternalIndexes(int start, int offset)
{
  ...
  {
    Mapping::right_const_iterator it = const_cast<const Mapping&>(m_mapping).rightLowerBound(start);
    const Mapping::right_const_iterator end = m_mapping.rightConstEnd();
