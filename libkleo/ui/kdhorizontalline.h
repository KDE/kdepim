...
public:
    explicit KDHorizontalLine(QWidget *parent = Q_NULLPTR, const char *name = Q_NULLPTR,  Qt::WindowFlags f = 0);
    explicit KDHorizontalLine(const QString &title, QWidget *parent = Q_NULLPTR, const char *name = Q_NULLPTR,  Qt::WindowFlags f = 0);
    ~KDHorizontalLine();
