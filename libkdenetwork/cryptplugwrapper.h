...
public:
    ...
    */
    ...
    CertificateInfoList listKeys(const QString& pattern = QString::null, bool remote = false,
				 bool *truncated = 0 );


    int importCertificate( const QString& fingerprint, QString* info );
    int importCertificate( const char* data, size_t length, QString* info );
