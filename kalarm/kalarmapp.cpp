      ...
      mSpeechEnabled(false)
{
    ...
    mWindowFocusBroken = (QProcessEnvironment::systemEnvironment().value(QLatin1String("XDG_CURRENT_DESKTOP")) == QLatin1String("Unity"));
    if (mWindowFocusBroken) kDebug() << "Window keyboard focus broken";
}
