...
*/
#ifndef _PILOTRECORD_H
#define _PILOTRECORD_H

#include <time.h>

#include "pilot-link/include/pi-file.h"
...
public:
	...
	bool isDirty() const { return fAttrib & dlpRecAttrDirty; }

	void makeDeleted() ;
	void makeSecret() ;
	void makeDirty(bool b) ;
...
inline void PilotRecord::makeDirty(bool b)
{ if (b) fAttrib |= dlpRecAttrDirty; else fAttrib &= ~dlpRecAttrDirty; } ;
