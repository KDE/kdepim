...
void AddresseeDiffAlgo::run()
{
  ...
  if ( !compareString( mLeftAddressee.uid(), mRightAddressee.uid() ) ) {
    conflictField( KABC::Addressee::uidLabel(),
                   mLeftAddressee.uid(), mRightAddressee.uid() );
  }

  if ( !compareString( mLeftAddressee.name(), mRightAddressee.name() ) ) {
    conflictField( KABC::Addressee::nameLabel(),
                   mLeftAddressee.name(), mRightAddressee.name() );
  }
  ...
  if ( !compareString( mLeftAddressee.formattedName(), mRightAddressee.formattedName() ) ) {
    conflictField( KABC::Addressee::formattedNameLabel(),
                   mLeftAddressee.formattedName(),
                   mRightAddressee.formattedName() );
  }
  ...
  if ( !compareString( mLeftAddressee.title(), mRightAddressee.title() ) ) {
    conflictField( KABC::Addressee::titleLabel(),
                   mLeftAddressee.title(), mRightAddressee.title() );
  }

  if ( !compareString( mLeftAddressee.role(), mRightAddressee.role() ) ) {
    conflictField( KABC::Addressee::roleLabel(),
                   mLeftAddressee.role(), mRightAddressee.role() );
  }
  ...
  if ( !compareString( mLeftAddressee.note(), mRightAddressee.note() ) ) {
    conflictField( KABC::Addressee::noteLabel(),
                   mLeftAddressee.note(), mRightAddressee.note() );
  }
