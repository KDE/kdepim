...
void Profile::setActionParts( const ActionPartService::List &list )
{
    m_actionPartServices = list;
}

ActionPartService::List Profile::actionParts() const
{
    return m_actionPartServices;
}
...
Profile &Profile::operator=( const Profile &prof )
{
    ...
    m_actionPartServices = prof.m_actionPartServices;
    m_map = prof.m_map;
