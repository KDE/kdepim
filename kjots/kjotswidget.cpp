    ...
    : QWidget( parent, f ), m_xmlGuiClient( xmlGuiClient )
{
  ...
  QAction *bm_action = actionCollection->action("bookmark_add");
  ...
  KActionMenu *exportMenu = actionCollection->add<KActionMenu>( "save_to" );
