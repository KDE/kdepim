...
class AddressBook
{
  public:
     ...
     */
    Entry *    findEntry(const QString & name);
    /**
     * Find the fields with the specified field name.
     */
    FieldList  findFields(const QString & fieldName);
    /**
     * Find the entries with the specified field name.
     */
    EntryList  findEntries(const QRegExp & expression);
    /**
     * Find the fields with the specified name.
     */
    FieldList  findFields(const QRegExp & expression);
    /**
     * Find the fields with the specified value type.
     */
    FieldList  findFieldsByValue(ValueType t);
    /**
     * Find the fields with the specified value type.
     */
    FieldList  findFieldsByValue(const QString & valueType);
    /**
     ...
     * @returns true if the entry could be replaced, false if not.
     */
    bool replaceEntry(const QString &, const Entry &);
    /**
