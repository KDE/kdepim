...
#ifndef STORAGESERVICECONFIGURESTORAGEWIDGETTEST_H
#define STORAGESERVICECONFIGURESTORAGEWIDGETTEST_H

#include <QObject>

class StorageServiceConfigureStorageWidgetTest : public QObject
{
    Q_OBJECT
public:
