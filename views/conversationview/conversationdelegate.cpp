...
ConversationDelegate::ConversationDelegate(FolderProxyModel *proxyModel, QObject *parent) : QAbstractItemDelegate(parent), model(proxyModel)
{
  margin = 5;
}
...
{
  Conversation *c = model->conversation(index);
