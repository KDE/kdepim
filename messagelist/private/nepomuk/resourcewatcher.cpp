      ...
      d(new Private)
{
    d->m_watchManagerInterface
            = new org::kde::nepomuk::ResourceWatcher( QLatin1String("org.kde.nepomuk.DataManagement"),
...
bool Nepomuk::ResourceWatcher::start()
{
    ...
    if(!path.path().isEmpty()) {
        d->m_connectionInterface = new org::kde::nepomuk::ResourceWatcherConnection( QLatin1String("org.kde.nepomuk.DataManagement"),
                                                                                     path.path(),
                                                                                     QDBusConnection::sessionBus() );
...
#include "private/nepomuk/resourcewatcher.moc"
