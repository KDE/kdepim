...
void Kleo::QGpgMEExportJob::slotCancel() {
  mCtx->cancelPendingOperation();
}

void Kleo::QGpgMEExportJob::slotOperationDoneEvent( GpgME::Context * context, const GpgME::Error & error ) {
  if ( context == mCtx ) {
    emit done();
...
void Kleo::QGpgMEExportJob::showProgress( const char * what, int type, int current, int total ) {
