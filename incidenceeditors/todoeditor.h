...
class INCIDENCEEDITORS_EXPORT TodoEditor : public IncidenceEditor
{
  ...
  protected:
    KCalCore::Incidence::IncidenceType type() const { return KCalCore::Incidence::TypeTodo; }
    QByteArray typeStr() const  { return "Todo"; }
  ...
  private:
    ...
    KCalCore::Todo::Ptr mInitialTodo;
    Akonadi::Item mInitialTodoItem;

    KCalCore::Todo::Ptr mRelatedTodo;
