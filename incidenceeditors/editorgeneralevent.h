...
class EditorGeneralEvent : public EditorGeneral
{
  ...
  public:
    ...
    */
    void readEvent( const KCalCore::Event::Ptr &event, const QDate &date, bool tmpl = false );

    /** Write event settings to event object */
    void fillEvent( KCalCore::Event::Ptr &  );

    /** Check if the input is valid. */
    bool validateInput();

    void updateRecurrenceSummary( const KCalCore::Event::Ptr &event );
