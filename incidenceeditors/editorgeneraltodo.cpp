...
void EditorGeneralTodo::readTodo( Todo *todo, const QDate &date, bool tmpl )
{
...
void EditorGeneralTodo::fillTodo( Todo *todo )
{
  EditorGeneral::fillIncidence( todo );
...
void EditorGeneralTodo::updateRecurrenceSummary( Todo *todo )
{
  if ( todo->recurs() ) {
...
bool EditorGeneralTodo::setAlarmOffset( Alarm *alarm, int value ) const
{
