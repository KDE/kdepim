...
class INCIDENCEEDITORS_EXPORT FreeBusyUrlDialog : public KDialog
{
  Q_OBJECT
  public:
  explicit FreeBusyUrlDialog( const KCalCore::Attendee::Ptr &, QWidget *parent = 0 );
...
class INCIDENCEEDITORS_EXPORT FreeBusyUrlWidget : public QWidget
{
  Q_OBJECT
  public:
  explicit FreeBusyUrlWidget( const KCalCore::Attendee::Ptr &, QWidget *parent = 0 );
    ~FreeBusyUrlWidget();
