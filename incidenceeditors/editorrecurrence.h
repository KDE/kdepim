...
*/
#ifndef EDITORRECURRENCE_H
#define EDITORRECURRENCE_H

#include <kcalcore/recurrence.h> //for DateList typedef
...
class ExceptionsBase
{
  public:
    ...
    virtual void setDates( const KCalCore::DateList & ) = 0;
    virtual KCalCore::DateList dates() = 0;
};
...
class ExceptionsWidget : public QWidget, public ExceptionsBase
{
  ...
  public:
    ...
    void setDates( const KCalCore::DateList & );
...
class EditorRecurrence : public QWidget
{
  Q_OBJECT
  public:
    explicit EditorRecurrence ( QWidget *parent = 0 );
    virtual ~EditorRecurrence();
...
class EditorRecurrenceDialog : public KDialog
{
  Q_OBJECT
  public:
