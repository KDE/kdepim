...
EditorAlarms::EditorAlarms( const QByteArray &type,
...
EditorAlarms::~EditorAlarms()
{
}

void EditorAlarms::slotDisplayRadioClicked()
{
  slotUpdateButtons();
...
void EditorAlarms::slotSoundRadioClicked()
{
  slotUpdateButtons();
...
void EditorAlarms::slotAppRadioClicked()
{
  slotUpdateButtons();
...
void EditorAlarms::slotEmailRadioClicked()
{
  slotUpdateButtons();
...
void EditorAlarms::slotUpdateButtons()
{
...
void EditorAlarms::itemSelectionChanged()
{
...
void EditorAlarms::slotDuplicate()
{
  if ( mCurrentItem ) {
