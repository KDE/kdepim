...
EditorGeneralJournal::~EditorGeneralJournal()
{
}

void EditorGeneralJournal::initTitle( QWidget *parent, QBoxLayout *topLayout )
{
  mParent = parent;
...
void EditorGeneralJournal::initDate( QWidget *parent, QBoxLayout *topLayout )
{
...
void EditorGeneralJournal::setDate( const QDate &date )
{
  mDateEdit->setDate( date );
}

void EditorGeneralJournal::setTime( const QTime &time )
{
...
void EditorGeneralJournal::initCategories( QWidget *parent, QBoxLayout *topLayout )
{
...
void EditorGeneralJournal::fillJournal( Journal *journal )
{
  ...
  KDateTime tmpDT( mDateEdit->date(), KSystemTimeZones::local() );
...
void EditorGeneralJournal::setSummary( const QString &text )
{
  mTitleEdit->setText( text );
}

void EditorGeneralJournal::finishSetup()
{
...
bool EditorGeneralJournal::validateInput()
{
...
#include "editorgeneraljournal.moc"
