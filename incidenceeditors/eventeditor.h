...
*/
class INCIDENCEEDITORS_EXPORT EventEditor : public IncidenceEditor
{
  Q_OBJECT
  public:
    /**
  ...
  protected:
    KCalCore::Incidence::IncidenceType type() const { return KCalCore::Incidence::TypeEvent; }
    QByteArray typeStr() const { return "Event"; }
  ...
  private:
    ...
    KCalCore::Event::Ptr mInitialEvent;
