    ...
    : QWidget(parent)
{
    ...
    mNoteEdit->setFocus();
    connect(mNoteEdit, &KLineEdit::returnPressed, this, &NoteEdit::slotReturnPressed);
    connect(mNoteEdit, &KLineEdit::textChanged, this, &NoteEdit::slotUpdateButtons);
...
#endif
    connect(mSaveButton, &KPushButton::clicked, this, &NoteEdit::slotReturnPressed);
...
#endif
    connect(btn, &KPushButton::clicked, this, &NoteEdit::slotCloseWidget);
    hbox->addWidget(btn);
