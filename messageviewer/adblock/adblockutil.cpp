...
QMap<QString, QString> MessageViewer::AdBlockUtil::listSubscriptions()
{
    ...
    lst.insert(QString::fromUtf8("Việt Nam List+EasyList"), QLatin1String("https://easylist-downloads.adblockplus.org/abpvn+easylist.txt"));
    ...
    lst.insert(QString::fromUtf8("IsraelList"), QLatin1String("http://israellist.googlecode.com/files/IsraelList.txt"));

    lst.insert(QString::fromUtf8("Morpeh Rus List+EasyList"), QLatin1String("https://easylist-downloads.adblockplus.org/morpeh+easylist.txt"));

    lst.insert(QString::fromUtf8("Morpeh Rus List"), QLatin1String("http://adblockplus.mihalkin.ru/Russia.txt"));

    lst.insert(QString::fromUtf8("Norsk adblockliste"), QLatin1String("http://home.online.no/~mlangsho/adblock.txt"));
    ...
    lst.insert(QString::fromUtf8("dutchblock"), QLatin1String("http://dutchmega.nl/dutchblock/list.txt"));
    ...
    lst.insert(QString::fromUtf8("Fanboy's Chinese"), QLatin1String("http://www.fanboy.co.nz/adblock/fanboy-adblocklist-chn.txt"));

    lst.insert(QString::fromUtf8("Fanboy's Czech"), QLatin1String("http://www.fanboy.co.nz/adblock/fanboy-adblocklist-cz.txt"));

    lst.insert(QString::fromUtf8("Fanboy's Espanol/Portuguese"), QLatin1String("http://www.fanboy.co.nz/adblock/fanboy-adblocklist-esp.txt"));

    lst.insert(QString::fromUtf8("Fanboy's Japanese"), QLatin1String("http://www.fanboy.co.nz/adblock/fanboy-adblocklist-jpn.txt"));

    lst.insert(QString::fromUtf8("Fanboy's Korean"), QLatin1String("http://www.fanboy.co.nz/adblock/fanboy-adblocklist-krn.txt"));

    lst.insert(QString::fromUtf8("Fanboy's Tracking/Stats Blocking"), QLatin1String("http://www.fanboy.co.nz/adblock/fanboy-adblocklist-stats.txt"));

    lst.insert(QString::fromUtf8("Fanboy's Turkish"), QLatin1String("http://www.fanboy.co.nz/adblock/fanboy-adblocklist-tky.txt"));

    lst.insert(QString::fromUtf8("Filter von MonztA"), QLatin1String("http://monzta.maltekraus.de/adblock.txt"));

    lst.insert(QString::fromUtf8("Filtros Nauscopicos"), QLatin1String("http://s3.amazonaws.com/lcp/maty/myfiles/AdBlock-Nauscopio-maty.txt"));

    lst.insert(QString::fromUtf8("Hackrus anti-advertisement"), QLatin1String("http://nsis.narod.ru/clean_internet/aag.txt"));

    lst.insert(QString::fromUtf8("Hackrus anti-advertisement supplemental"), QLatin1String("http://nsis.narod.ru/clean_internet/aas.txt"));

    lst.insert(QString::fromUtf8("Hackrus anti-counter"), QLatin1String("http://nsis.narod.ru/clean_internet/ac.txt"));
    ...
    lst.insert(QString::fromUtf8("Lista Basa"), QLatin1String("http://www.photographer.neostrada.pl/abp.txt"));
    ...
    lst.insert(QString::fromUtf8("UA-IX Бан-лист"), QLatin1String("http://adblock.oasis.org.ua/banlist.txt"));
    ...
    lst.insert(QString::fromUtf8("Malware Domains"),QLatin1String("http://malwaredomains.lanik.us/malwaredomains_full.txt"));
