...
signals:
  void closeMe(int);
public:
  // CALSYS added calendarSystem support
  KDateInternalYearSelector(int fontsize,
			    KCalendarSystem* cSystem,
			    QWidget* parent=0,
			    const char* name=0);
  int getYear();
...
{
private:
    // CALSYS: support for different calendar types
    KCalendarSystem* calendarSystem;
// CALSYS: added optional calType parameter for different validator calendar types support
public:
    KDateValidator(const QString& calType = "gregorian", QWidget* parent=0, const char* name=0);
...
public:
     ...
     * The constructor.
     */
    // CALSYS: added optional calType parameter for different datetable calendar types support
    KDateTable(const QString& calType = "gregorian",
    	       QWidget *parent=0,
