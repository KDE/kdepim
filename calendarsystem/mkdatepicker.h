...
*/
#ifndef MKDATEPICKER_H
#define MKDATEPICKER_H
#include <qdatetime.h>
#include <qframe.h>
// CALSYS
...
public:
   ...
   * initially.
   **/
  // CALSYS  Added optional calType parameter for different calendar types support
  KDatePicker(const QString& calType = "gregorian",
  	      QWidget *parent=0,
