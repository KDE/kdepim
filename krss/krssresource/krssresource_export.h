...
#ifndef KRSSRESOURCE_EXPORT_H
#define KRSSRESOURCE_EXPORT_H

/* needed for KDE_EXPORT and KDE_IMPORT macros */
#include <kdemacros.h>

#ifndef KRSSRESOURCE_EXPORT
# if defined(MAKE_KRSSRESOURCE_LIB)
   /* We are building this library */
#  define KRSSRESOURCE_EXPORT KDE_EXPORT
# else
   /* We are using this library */
#  define KRSSRESOURCE_EXPORT KDE_IMPORT
# endif
#endif
