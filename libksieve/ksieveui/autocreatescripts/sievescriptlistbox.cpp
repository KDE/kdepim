...
void SieveScriptListBox::loadScript(const QDomDocument &doc)
{
    ...
    loadBlock(n, currentPage, typeBlock);
}

void SieveScriptListBox::loadBlock(QDomNode &n, SieveScriptPage *currentPage, ParseSieveScriptTypeBlock typeBlock)
{
    QString scriptName;
    QString comment;
            ...
            if (tagName == QLatin1String("control")) {
                ...
                if (e.hasAttribute(QLatin1String("name"))) {
                    ...
                    if (controlType == QLatin1String("if")) {
                        ...
                        loadBlock(block, currentPage, typeBlock);
