...
void GenerateGlobalScriptJob::writeMasterScript()
{
    ...
    connect(mMasterjob, SIGNAL(result(KManageSieve::SieveJob*,bool,QString,bool)), this, SLOT(slotPutMasterResult(KManageSieve::SieveJob*,bool)));
}
...
void GenerateGlobalScriptJob::writeUserScript()
{
    ...
    connect(mUserJob, SIGNAL(result(KManageSieve::SieveJob*,bool,QString,bool)), this, SLOT(slotPutUserResult(KManageSieve::SieveJob*,bool)));
}
