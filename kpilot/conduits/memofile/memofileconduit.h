#ifndef MEMOFILECONDUIT_H
#define MEMOFILECONDUIT_H
/* memofileconduit.h			KPilot
**
...
class MemofileConduit : public RecordConduit
{
public:
	explicit MemofileConduit( KPilotLink *o, const QVariantList &a = QVariantList() );
