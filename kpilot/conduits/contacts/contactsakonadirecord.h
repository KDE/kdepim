#ifndef CONTACTSAKONADIRECORD_H
#define CONTACTSAKONADIRECORD_H
...
class ContactsAkonadiRecord : public AkonadiRecord
{
public:
	/**
	 ...
	 * sync.
	 */
	ContactsAkonadiRecord( const Akonadi::Item& i, const QDateTime& lastSync );
	
	/**
	 * Creates an empty record with given id which is marked for deletion.
	 */
	ContactsAkonadiRecord( const QString& id );
