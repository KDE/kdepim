...
public:
	...
	KeyringHHDataProxy* hhProxy() const;
	
	KeyringHHDataProxy* backupProxy() const;
	
	KeyringHHDataProxy* pcProxy() const;
...
private:
	...
	KeyringHHDataProxy* hhDataProxy;
	KeyringHHDataProxy* backupDataProxy;
	KeyringHHDataProxy* pcDataProxy;
};
