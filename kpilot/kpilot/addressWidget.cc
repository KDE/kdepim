	...
	for(i = 0; i < 15; i++)
		...
		if (debug_level>=UI_ACTIONS)
		{
			cerr << fname << 
				...
				" with ID: " << 
				(int)fAddressAppInfo.category.ID[i] << endl;
		}
