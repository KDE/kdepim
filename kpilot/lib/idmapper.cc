...
Q3ValueList<QString> IDMapper::getPCObjectIds( const QString &conduit )
{
	FUNCTIONSETUP;
	
	Q3ValueList<IDMapping> &mappings = fP->fXmlSource->mappings();
	Q3ValueList<IDMapping>::iterator it;
	Q3ValueList<QString> uids;
...
Q3ValueList<recordid_t> IDMapper::getHHObjectIds( const QString &conduit )
{
	FUNCTIONSETUP;
	
	Q3ValueList<IDMapping> &mappings = fP->fXmlSource->mappings();
	Q3ValueList<IDMapping>::iterator it;
	Q3ValueList<recordid_t> pids;
