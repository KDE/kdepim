...
**
** Created: Sun Feb 10 13:48:17 2002
    ...
    : QWidget( parent, name, fl )
{
    ...
    DisplaySettingsFormLayout = new QVBoxLayout( this, 11, 6, "DisplaySettingsFormLayout"); 

    ButtonGroup1 = new QButtonGroup( this, "ButtonGroup1" );
    ButtonGroup1->setTitle( tr2i18n( "Quoted text colors" ) );
    ...
    l_depth1->setText( tr2i18n( "> Example" ) );
    ...
    l_depth2->setText( tr2i18n( "> > Example" ) );
