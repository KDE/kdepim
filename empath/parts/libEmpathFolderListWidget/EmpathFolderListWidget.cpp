...
extern "C"
{
    void *init_libEmpathFolderListWidget()
    {
        return new EmpathFolderListPartFactory;
    }
}

KInstance * EmpathFolderListPartFactory::instance_ = 0L;

EmpathFolderListPartFactory::EmpathFolderListPartFactory()
{
    // Empty.
}
...
{
    QObject * o = new EmpathFolderListPart((QWidget *)parent, name);
    emit objectCreated(o);
    return o;
}

    KInstance *
EmpathFolderListPartFactory::instance()
{
    if (0 == instance_)
        instance_ = new KInstance("EmpathFolderListWidget");
...
{
    setInstance(EmpathFolderListPartFactory::instance());

    widget_ = new EmpathFolderListWidget(parent);
...
EmpathFolderListPart::~EmpathFolderListPart()
{
    ...
    void
EmpathFolderListPart::enableAllActions(bool)
{
    // STUB
}

    void
EmpathFolderListPart::_initActions()
{
}
