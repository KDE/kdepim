...
#include "testfreebusyitemmodel.moc"
...
void FreeBusyItemModelTest::testModelValidity()
{
    ...
    QCOMPARE( a1,  model->data( i, FreeBusyItemModel::AttendeeRole ).value<KCalCore::Attendee::Ptr>() );
    QCOMPARE( item1->freeBusy(),  model->data( i, FreeBusyItemModel::FreeBusyRole ).value<KCalCore::FreeBusy::Ptr>() );
...
void FreeBusyItemModelTest::testModelValidity2()
{
    ...
    QCOMPARE( a1,  model->data( i1, FreeBusyItemModel::AttendeeRole ).value<KCalCore::Attendee::Ptr>() );
    QCOMPARE( item1->freeBusy(),  model->data( i1, FreeBusyItemModel::FreeBusyRole ).value<KCalCore::FreeBusy::Ptr>() );

    QModelIndex i2 = model->index( 1,0 );
    QCOMPARE( a2->fullName(),  model->data( i2, Qt::DisplayRole ).toString() );
    QCOMPARE( a2,  model->data( i2, FreeBusyItemModel::AttendeeRole ).value<KCalCore::Attendee::Ptr>() );
    ...
    QCOMPARE( a3,  model->data( i3, FreeBusyItemModel::AttendeeRole ).value<KCalCore::Attendee::Ptr>() );
    ...
    QCOMPARE( item2->freeBusy(),  model->data( i2, FreeBusyItemModel::FreeBusyRole ).value<KCalCore::FreeBusy::Ptr>() );
    QVERIFY( model->rowCount( i2 ) == fb2->fullBusyPeriods().size() );

    QModelIndex i2_0 = model->index( 0,0, i2 );
    QCOMPARE( fb2->fullBusyPeriods().first(), model->data( i2_0, FreeBusyItemModel::FreeBusyPeriodRole ).value<KCalCore::FreeBusyPeriod>() );
    QModelIndex i2_1 = model->index( 1,0, i2 );
    QCOMPARE( fb2->fullBusyPeriods().at( 1 ), model->data( i2_1, FreeBusyItemModel::FreeBusyPeriodRole ).value<KCalCore::FreeBusyPeriod>() );
    QModelIndex i2_2 = model->index( 2,0, i2 );
    QCOMPARE( fb2->fullBusyPeriods().last(), model->data( i2_2, FreeBusyItemModel::FreeBusyPeriodRole ).value<KCalCore::FreeBusyPeriod>() );

    model->slotInsertFreeBusy( fb3, "max@example.com" );
    QCOMPARE( item3->freeBusy(),  model->data( i3, FreeBusyItemModel::FreeBusyRole ).value<KCalCore::FreeBusy::Ptr>() );
    QVERIFY( model->rowCount( i3 ) == fb3->fullBusyPeriods().size() );

    QModelIndex i3_0 = model->index( 0,0, i3 );
    QCOMPARE( fb3->fullBusyPeriods().first(), model->data( i3_0, FreeBusyItemModel::FreeBusyPeriodRole ).value<KCalCore::FreeBusyPeriod>() );
    QModelIndex i3_1 = model->index( 1,0, i3 );
    QCOMPARE( fb3->fullBusyPeriods().at( 1 ), model->data( i3_1, FreeBusyItemModel::FreeBusyPeriodRole ).value<KCalCore::FreeBusyPeriod>() );
    QModelIndex i3_2 = model->index( 2,0, i3 );
    QCOMPARE( fb3->fullBusyPeriods().last(), model->data( i3_2, FreeBusyItemModel::FreeBusyPeriodRole ).value<KCalCore::FreeBusyPeriod>() );
