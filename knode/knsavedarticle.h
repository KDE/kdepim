...
class KNSavedArticle : public KNArticle  {
  ...
  public:
    ...
    //get   
    virtual articleType type()            { return ATsaved; }
    ...
    virtual bool editable()     { return (s_tatus==AStoPost || s_tatus==AStoMail); }
...
class KNControlArticle : public KNSavedArticle  {
  ...
  public:
    KNControlArticle(controlType t, articleStatus s=ASunknown);
    ~KNControlArticle();
    
    //get
    virtual articleType type()      { return ATcontrol; }
    controlType ctlType()           { return c_tlType; }

    virtual bool editable()         { return ( (s_tatus==AStoPost) && (ctlType()==CTsupersede) ); }
