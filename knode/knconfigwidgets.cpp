...
KNConfig::ReadNewsViewerWidget::ReadNewsViewerWidget( ReadNewsViewer *d, QWidget *p, const char *n ) :
  ...
  d_ata( d )
{
  Q3GroupBox *appgb=new Q3GroupBox(i18n("Appearance"), this);
  Q3GroupBox *agb=new Q3GroupBox(i18n("Attachments"), this);
  Q3GroupBox *secbox = new Q3GroupBox( i18n("Security"), this );
