...
class KNPgpPass : public KDialogBase
{
  Q_OBJECT

  public:
    KNPgpPass(QWidget *parent=0, const QString &name=QString::null, bool modal=true );
    virtual ~KNPgpPass();
...
// -------------------------------------------------------------------------
/** the passphrase dialog */
class KNPgpKey : public KDialogBase
{
  Q_OBJECT

  public:
    KNPgpKey( QStrList *keys, QWidget *parent=0, const char *name=0, 
	     bool modal=true );
    virtual ~KNPgpKey();
...
/** a widget for configuring the pgp interface. Can be included into
    ...
    button mechanism. */
class KNPgpConfig : public QWidget
{
  Q_OBJECT

  public:
    KNPgpConfig(QWidget *parent = 0, const char *name = 0);
    virtual ~KNPgpConfig();
...
// -------------------------------------------------------------------------
class KNPgpSelDlg: public KDialogBase
{
  Q_OBJECT

  public:
    KNPgpSelDlg( const QStrList &keyList, const QString &recipent,
