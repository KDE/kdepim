...
/*!
  Sets the task lnk group to 0 without doing anything else.
  Called from the destructor of the KDGanttViewTaskLinkGroup this
  tasklink belongs to.

  \sa setGroup()
*/
void KDGanttViewTaskLink::resetGroup()
{
    myGroup = 0;
}
