...
OperaXXPort::OperaXXPort( QWidget *parent )
  : XXPort( parent )
{
}

KABC::Addressee::List OperaXXPort::importContacts() const
{
...
bool OperaXXPort::exportContacts( const KABC::Addressee::List &contacts ) const
{
