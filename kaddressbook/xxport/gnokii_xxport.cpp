...
K_EXPORT_KADDRESSBOOK_XXFILTER( kaddrbk_gnokii_xxport, GNOKIIXXPort )
...
static QString buildPhoneInfoString( const gn_memory_status &memstat )
{
	...
	return QString::fromLatin1("<b>%1</b><br><table>%2%3%4%5%6</table><br>")
		...
		.arg(format.arg(i18n("Phonebook status"))
			   .arg(i18np("%2 out of 1 contact used", "%2 out of %1 contacts used", memstat.used+memstat.free, memstat.used)));
}
			...
			KABC::AddresseeList *addrList )
{
  ...
  m_progressDlg->setLabelText(i18np(	  "<qt>Importing <b>1</b> contact from <b>%2</b> of the Mobile Phone.<br /><br />%3</qt>",
...
bool GNOKIIXXPort::exportContacts( const KABC::AddresseeList &list, const QString & )
{
	...
	m_progressDlg->setLabelText(i18np("<qt>Exporting <b>1</b> contact to the <b>%2</b> "
