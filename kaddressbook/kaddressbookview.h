...
class KAddressBookView : public QWidget
{
  ...
  public:
    ...
    KAddressBookView(KABC::AddressBook *doc,
    ...
    * list of fields.
    */
    KABC::Field::List fields() const { return mFieldList; }
    ...
    * defaultFilterName()
    */
    DefaultFilterType defaultFilterType() const { return mDefaultFilterType; }
  ...
  public slots:
    ...
    */
    virtual void setSelected(QString uid = QString::null,
                             bool selected = true) = 0;
  ...
  protected:
    ...
    */
    QWidget *viewWidget() { return mViewWidget; }

  protected slots:


  private:
    /** Initializes all the GUI components of the view.
    */
    void initGUI();
