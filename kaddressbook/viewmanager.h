...
class ViewManager : public QWidget
{
  ...
  public:
    ...
    */
    ...
    /** Used to enable or disable the incremental search widget.
    *
    * @param visible True for the widget to be visible, false otherwise
    */
    void setIncrementalSearchVisible(bool visible);
  ...
  protected slots:
   /** Called whenever the text in the incremental search line edit
    * is changed.
    */
    void incrementalSearchTextChanged(const QString &text);
    
    /** Called whenever return is pressed in the incremental search
    * line edit.
    */
    void incrementalSearchReturnPressed();
    
    /** Called whenever the incremental search combo box is activated (when
    * an item is selected).
    */
    void incrementalSearchComboActivated(const QString &text);
  ...
  private:
    ...
    */
    ...
    QLineEdit *mIncrementalSearchEdit;
    QComboBox *mIncrementalSearchCombo;
