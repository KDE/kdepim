...
icalparameter* icalparameter_new_from_value_string(icalparameter_kind kind,const  char* val)
{
    ...
    if(found_kind == 1){
        ...
        ((struct icalparameter_impl*)param)->string = strdup(val);
...
{ICAL_ANY_PARAMETER,0,""},
    ...
    {ICAL_VALUE_PARAMETER,ICAL_VALUE_DATETIME,"DATETIME"},
    {ICAL_VALUE_PARAMETER,ICAL_VALUE_UTCOFFSET,"UTCOFFSET"},
    {ICAL_VALUE_PARAMETER,ICAL_VALUE_CALADDRESS,"CALADDRESS"},
