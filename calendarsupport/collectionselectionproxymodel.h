...
#ifndef CALENDARSUPPORT_COLLECTIONSELECTIONPROXYMODEL_H
#define CALENDARSUPPORT_COLLECTIONSELECTIONPROXYMODEL_H
 ...
 */
class CALENDARSUPPORT_EXPORT_DEPRECATED CollectionSelectionProxyModel : public QSortFilterProxyModel
{
  Q_OBJECT
