...
EntityModelStateSaver::EntityModelStateSaver( QAbstractItemModel *model, QObject *parent )
  : ModelStateSaver( model, parent ), d( 0 ) {
}
...
QString EntityModelStateSaver::key( const QModelIndex &index ) const
{
  ...
  return QString::fromLatin1( "i%1" ).
    arg( index.data( Akonadi::EntityTreeModel::ItemIdRole ).value<Akonadi::Entity::Id>() );
}
