...
bool CollectionSelectionProxyModel::setData( const QModelIndex &index, const QVariant &value,
                                             int role )
{
...
bool CollectionSelectionProxyModel::filterAcceptsColumn( int sourceColumn,
