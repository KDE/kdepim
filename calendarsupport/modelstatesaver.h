...
#ifndef CALENDARSUPPORT_MODELSTATESAVER_H
#define CALENDARSUPPORT_MODELSTATESAVER_H
...
*/
class CALENDARSUPPORT_EXPORT_DEPRECATED ModelStateSaver : public QObject
{
  Q_OBJECT
  public:
     ...
     * @param identifier Identifier used internally to write/read the role values.
     * Must only contain letters (a-z) or digits (0-9)!
     * @param defaultValue The value that should be set if nothing is stored in the settings.
     * When saving, values equal to the default value are not explicitly stored
     */
