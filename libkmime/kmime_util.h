...
namespace KMime {
  ...
  public:
     ...
     */
    QString dateString(
      time_t otime, const QString& lang=QString(),
     ...
     */
    QString dateString(
      const QDateTime& dtime, const QString& lang=QString(),
      bool shortFormat=true, bool includeSecs=false ) const;
    ...
    static QString  formatDate(
      DateFormatter::FormatType t, time_t time,
      const QString& data=QString(), bool shortFormat=true,
    ...
    static QString  formatCurrentDate(
      DateFormatter::FormatType t, const QString& data=QString(),
  ...
  protected:
     ...
     */
    QString localized(
      time_t otime, bool shortFormat=true, bool includeSecs=false,
